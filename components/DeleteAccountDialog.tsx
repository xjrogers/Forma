      ...
      >
        ...
        <div className="p-6">
          <p className="text-muted-foreground mb-4">
            This action cannot be undone. This will permanently delete your account and all associated data including projects, files, and conversation history.
          </p>
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!loading && confirmText === userEmail) {
